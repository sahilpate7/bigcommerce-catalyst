...
export const ProductCard = ({
  ...
  return (
    <ComponentsProductCard key={product.entityId} className='px-3 relative group bg-gray-100 rounded-xl hover:bg-gray-200 pb-5'>
      <ProductCardImage>
        <div
      ...
      <ProductCardInfo className={cn(showCart && 'justify-start')}>
      ...
      <div className='absolute hidden group-hover:inline-block top-50% left-50% translate-y-m50% translate-x-m50%'>
